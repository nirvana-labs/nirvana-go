...
- <code title="get /v1/regions/{region_name}">client.Regions.<a href="https://pkg.go.dev/github.com/nirvana-labs/nirvana-go/regions#RegionService.Get">Get</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, regionName <a href="https://pkg.go.dev/builtin#string">string</a>) (<a href="https://pkg.go.dev/github.com/nirvana-labs/nirvana-go/regions">regions</a>.<a href="https://pkg.go.dev/github.com/nirvana-labs/nirvana-go/regions#Region">Region</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
