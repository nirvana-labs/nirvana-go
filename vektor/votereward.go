...
// VoteRewardService contains methods and other services that help with interacting
// with the Nirvana Labs API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewVoteRewardService] method instead.
type VoteRewardService struct {
	Options []option.RequestOption
}

// NewVoteRewardService generates a new service that applies the given options to
...
func (r *VoteRewardService) List(ctx context.Context, body VoteRewardListParams, opts ...option.RequestOption) (res *VoteRewardListResponse, err error) {
	opts = append(r.Options[:], opts...)
	path := "v1/vektor/vote/rewards"
...
func (r VoteRewardListResponse) RawJSON() string { return r.JSON.raw }
...
func (r VoteRewardListParams) MarshalJSON() (data []byte, err error) {
	type shadow VoteRewardListParams
