...
func TestBuyQuoteListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vektor.Buy.Quotes.List(context.TODO(), vektor.BuyQuoteListParams{
		Blockchain:       "blockchain_01jbz9nsy8egar70jg79dkwmaf",
		ReceiveAmount:    "10.0000000000000024",
