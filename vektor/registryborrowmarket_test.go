...
func TestRegistryBorrowMarketListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vektor.Registry.BorrowMarkets.List(context.TODO(), vektor.RegistryBorrowMarketListParams{
