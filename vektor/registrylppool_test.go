...
func TestRegistryLPPoolListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vektor.Registry.LPPools.List(context.TODO(), vektor.RegistryLPPoolListParams{
		ID:         nirvana.String("lp_pool_01h455vb4pex5vsknk084sn02q"),
