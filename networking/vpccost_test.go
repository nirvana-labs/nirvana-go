...
func TestVPCCostNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Networking.VPCs.Cost.New(context.TODO(), networking.VPCCostNewParams{
		Name:       "my-vpc",
...
func TestVPCCostUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
