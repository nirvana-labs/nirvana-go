...
type ComputeVMService struct {
	...
	OSImages *ComputeVMOSImageService
}
...
func NewComputeVMService(opts ...option.RequestOption) (r *ComputeVMService) {
	r = &ComputeVMService{}
	r.Options = opts
	r.OSImages = NewComputeVMOSImageService(opts...)
	return
}

// Create a VM
func (r *ComputeVMService) New(ctx context.Context, body ComputeVMNewParams, opts ...option.RequestOption) (res *Operation, err error) {
...
// Update a VM
func (r *ComputeVMService) Update(ctx context.Context, vmID string, body ComputeVMUpdateParams, opts ...option.RequestOption) (res *Operation, err error) {
	opts = append(r.Options[:], opts...)
	if vmID == "" {
...
// Delete a VM
func (r *ComputeVMService) Delete(ctx context.Context, vmID string, opts ...option.RequestOption) (res *Operation, err error) {
	opts = append(r.Options[:], opts...)
	if vmID == "" {
		err = errors.New("missing required vm_id parameter")
		return
